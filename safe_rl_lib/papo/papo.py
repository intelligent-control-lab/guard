...
if __name__ == '__main__':
    ...
    if args.atari_name == None:
        ...
        import gymnasium
        detail = 'Detailed' if args.detailed else 'notDetailed'
        exp_name = args.atari_name + '_' + args.exp_name + '_' + detail + '_' + 'kl' + str(args.target_kl) + '_' + 'epochs' + str(args.epochs)
    ...
    papo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        atari=args.atari_name, k=args.k, omega_1=args.omega1, omega_2=args.omega2, detailed=args.detailed)
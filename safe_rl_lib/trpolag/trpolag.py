...
def trpolag(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        steps_per_epoch=4000, epochs=50, gamma=0.99, pi_lr=3e-4, vf_lr=1e-3, vcf_lr=1e-3, 
        lam_lr=1e-2, train_v_iters=80, train_vc_iters=80, lam=0.97, max_ep_len=1000, target_kl=0.01, 

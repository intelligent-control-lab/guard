...
def usl(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, steps_per_epoch=4000, 
        epochs=50, gamma=0.99, pi_lr=3e-4, vf_lr=1e-3, ccritic_lr=1e-3, 
        train_v_iters=80, train_ccritic_iters=80, lam=0.97, max_ep_len=1000, target_kl=0.01,
    ...
    buf = UslBuffer(obs_dim, act_dim, local_steps_per_epoch, gamma, lam)
